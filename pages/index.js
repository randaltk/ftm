      ...
      <div>
        <section className={styles.sessaoSobre}>
          <div className={styles.contentPresentation}>
            <div className={styles.sessaoPadrao}>
              ...
              <div className={styles.contentBannerFull}>
                <Image
                  src="https://res.cloudinary.com/aguadeira/image/upload/q_auto,f_auto/v1768323125/FTM/assinatura_2026_ckqusd.jpg"
                  alt="Inspeção"
                  width={1200}
                  height={600}
                  quality={90}
              ...
              <div className={styles.sessaoComImagem}>
                ...
                <div className={styles.sessaoContent}>
                  <p className={styles.description}>
                    ...
                    tensionadores e projetos especiais que proporcionam
                    facilidade e confiabilidade a diversas procedimentos de
                    montagens industriais, onde há a necessidade de torqueamento
                    ou tensionamento controlado, através de modernas ferramentas
              ...
              <div className={styles.sessaoComImagem}>
                <div className={styles.sessaoContent}>
                  <p className={styles.description}>
                    ...
                    principal a qualidade e competitividade no mercado, através
                    de seu atendimento personalizado desde a comercialização de
                    seus produtos e serviços, até o pós venda. Nossa Missão é,
                    satisfazer nossos clientes, oferecendo conforto, praticidade
                    e segurança dos produtos e serviços ofertados. Recompensados
                    pelo nosso trabalho, nos tornamos, uma das principais
                    empresas do ramo de venda, locação de chaves de torque e
                    tensionadores hidráulicos, além de projetos especiais e
                    apoio técnico no seguimento de torqueamento e tensionamento
                    controlado de parafusos, onde atendemos vários setores da
                    nossa economia do mercado brasileiro. Nosso maior patrimônio
                    é a satisfação de nossos clientes, além da preocupação com a
                    segurança dos usuários dos nossos produtos.
                  </p>
                </div>
                <div className={styles.contentBanner}>
                  <Image
        ...
        <section className={styles.sessaoServicos}>
          ...
          <div className={styles.sessaoSegmentos}>
